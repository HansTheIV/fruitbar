...
qk_tap_dance_action_t tap_dance_actions[] = {
  ...
  [SPACE_ARR_LAYER] = ACTION_TAP_DANCE_DOUBLE(KC_SPC, MO(_ARR)),
};
}
...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [_BASE] = LAYOUT(
           ...
           KC_LCTRL, KC_LGUI, KC_LALT,    KC_SPC, TD(SPACE_ARR_LAYER), TD(SPACE_FN_LAYER),KC_RALT, MO(_FN), KC_RCTRL,   KC_LEFT, KC_DOWN, KC_RIGHT
  ),
  ...
  [_ARROWS] = LAYOUT(
    KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_HOME, KC_END, KC_TRNS, KC_TRNS,      KC_TRNS, KC_TRNS,
